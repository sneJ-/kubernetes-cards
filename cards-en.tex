...
%   \cardtitle{\vspace{-5mm}SEHR LANGER TITEL}
    ...
    \begin{tikzpicture}
        \cardbackground{img/ingress-controller.jpeg}
        \cardtypeNetwork
...
%       \carddebug
    ...
    \hspace{5mm}
    \begin{tikzpicture}
        \cardbackground{img/netpol.jpeg}
        \cardtypeNetwork
    ...
    \hspace{5mm}
    \begin{tikzpicture}
        \cardbackground{img/pod-restart.jpeg}
        \cardtypeEvent
